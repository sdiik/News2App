...
class HomeViewModel: ObservableObject {
    ...
    init(newsUseCase: FetchNewsUseCase = FetchNewsUseCaseImpl()) {
        ...
        self.title = CustomTextViewModel(config: Self.makeTitleConfigurate())
        self.desc = CustomTextViewModel(config: Self.makeDescConfigurate())
        self.articelSection = SectionViewModel()
        self.blogSection = SectionViewModel()
        self.reportSection = SectionViewModel()
    }
