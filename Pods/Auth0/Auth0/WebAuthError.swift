    ...
    extension WebAuthError {
        var message: String {
            ...
            case let .invalidInvitationURL(url): return "The invitation URL (\(url)) is missing the 'invitation' and/or"
            ...
            case let .noAuthorizationCode(values): return "The callback URL is missing the authorization code in its"
