...
public struct Telemetry {
    ...
    static func osInfo() -> (String, String) {
        return (osPlatform(), "\(ProcessInfo().operatingSystemVersion.majorVersion).\(ProcessInfo().operatingSystemVersion.minorVersion)")
    }
}
...
public extension Trackable {
    ...
    mutating func using(inLibrary name: String, version: String) {
        telemetry.wrapped(inLibrary: name, version: version)
    }
}
